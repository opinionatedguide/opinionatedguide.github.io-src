...
![transistor](../content/openg/transistor.jpg)
...
![2019-02-08-145014_2400x522_scrot](../content/openg/godbolt.png)
...
![lstopo](../content/openg/lstopo.png)
...
![procint](../content/openg/procint.png)

> Output of `cat /proc/interupts` on my system

![netdataint](../content/openg/netdataint.png)
...
![cpupower](../content/openg/cpupower.png)
...
![dmiram](../content/openg/dmiram.png)
...
To see what your fans are doing on Linux you'll need to grab the package `lm_sensors` with yay, then you can run run `sudo sensors-decect` and mash enter until it's done. After this you should be able to run `sensors` and see an output similar to this one:![sense](../content/openg/sensors.png)
...
![lstopo2](../content/openg/lstopo.png)
...
![pciecards](../content/openg/pciecards.jpg)
...
![gcards](../content/openg/gcards.jpg)
...
![1900px-raven_ridge_die_(annotated)](../content/openg/1900px-raven_ridge_die_(annotated).png)
...
For bulk storage servers you can get insane capacities, and building one yourself isn't all that hard. Here's mine:![powervault](../content/openg/powervault.jpg)
